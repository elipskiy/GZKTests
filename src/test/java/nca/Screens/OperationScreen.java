...
/**
 * Created by makovskiy on 18.02.2015.
 */
public class OperationScreen {
    ...
    OperationScreen(WebDriver driver) {
        wrapper = new DriverWrapper(driver);
    }

    //******************************************************************************************************************
    public String getOperationPageTitle() throws InterruptedException, AWTException {
    ...
    //******************************************************************************************************************
    public void verifyElemOperationPageTitle() throws InterruptedException, AWTException {
        wrapper.clickByXpath(UR_USER_XPATH);
        wrapper.sendKeysByXpath(FIZFACE_XPATH, "Пупкин");
        wrapper.clickByXpath(ADD_EDIT_DATA_XPATH);
        Thread.sleep(2000);
    ...
    //******************************************************************************************************************
    public String verifyTitleAfterFilingAllData() throws InterruptedException, AWTException {
        wrapper.clickByXpath(UR_USER_XPATH);
        wrapper.sendKeysByXpath(FIZFACE_XPATH, "Пупкин");
        wrapper.clickByXpath(ADD_EDIT_DATA_XPATH);
        Thread.sleep(2000);
    ...
    //******************************************************************************************************************
    public void verifyBackBtnAfterFilingAllData() throws InterruptedException, AWTException {
        wrapper.clickByXpath(UR_USER_XPATH);
        wrapper.sendKeysByXpath(FIZFACE_XPATH, "Пупкин");
        wrapper.clickByXpath(ADD_EDIT_DATA_XPATH);
        Thread.sleep(2000);
    ...
    //******************************************************************************************************************
    public boolean verifySaveAfterFilingAllData() throws InterruptedException, AWTException {
        wrapper.clickByXpath(UR_USER_XPATH);
        wrapper.sendKeysByXpath(FIZFACE_XPATH, "Пупкин");
        wrapper.clickByXpath(ADD_EDIT_DATA_XPATH);
        Thread.sleep(2000);
        ...
        boolean elemIsFinded = wrapper.containText(randomObjName);
        return elemIsFinded;
    }

    //******************************************************************************************************************
    public void filingDoingDateBeforeToday() throws InterruptedException, AWTException {
        wrapper.clickByXpath(UR_USER_XPATH);
        wrapper.sendKeysByXpath(FIZFACE_XPATH, "Пупкин");
        wrapper.clickByXpath(ADD_EDIT_DATA_XPATH);
        Thread.sleep(2000);
        ...
        Random rand = new Random();
        String randomObjName = MyRandom.generateString(rand, "ПРОИЗВОЛЬНОЕИМЯ", 8);
        wrapper.sendKeysByXpath(NAME_OBJ_FIELD_XPATH, randomObjName);
        ...
        Thread.sleep(500);
        wrapper.clickByXpath(WORK_NAME_SELECT100_XPATH);
        wrapper.sendKeysByXpath(DOC_DATA_FIELD_XPATH,"21.12.2000");
        Thread.sleep(500);
        wrapper.clickByXpath(EXECUTOR_SELECT_XPATH);
        wrapper.clickByXpath(EXECUTOR_SELECT3_XPATH);
        Thread.sleep(500);
    ...
    //******************************************************************************************************************
    public void noFilingExAndChecking() throws InterruptedException, AWTException {
        wrapper.clickByXpath(UR_USER_XPATH);
        wrapper.sendKeysByXpath(FIZFACE_XPATH, "Пупкин");
        wrapper.clickByXpath(ADD_EDIT_DATA_XPATH);
        Thread.sleep(2000);
        ...
        Thread.sleep(500);
        wrapper.clickByXpath(WORK_NAME_SELECT100_XPATH);
        wrapper.sendKeysByXpath(DOC_DATA_FIELD_XPATH,"04.02.2016");
        Thread.sleep(500);

        wrapper.sendKeysByXpath(STATUS_DATA_FIELD_XPATH,"04.02.2016");
        Thread.sleep(500);
        wrapper.sendKeysByXpath(DOC_COMMENT_FIELD_XPATH,"Комментарий");
        wrapper.clickByXpath(FOWRWARD_BTN_XPATH);
        Thread.sleep(2000);
    ...
    //******************************************************************************************************************
    public void filingCommentLatinSymbols() throws InterruptedException, AWTException {
        wrapper.clickByXpath(UR_USER_XPATH);
        wrapper.sendKeysByXpath(FIZFACE_XPATH, "Пупкин");
        wrapper.clickByXpath(ADD_EDIT_DATA_XPATH);
        Thread.sleep(2000);
    ...
    //******************************************************************************************************************
    public void filingCommentIncorrectSymbols() throws InterruptedException, AWTException {
        wrapper.clickByXpath(UR_USER_XPATH);
        wrapper.sendKeysByXpath(FIZFACE_XPATH, "Пупкин");
        wrapper.clickByXpath(ADD_EDIT_DATA_XPATH);
        Thread.sleep(2000);
    ...
    //******************************************************************************************************************
    public String filingCommentCorrectSymbols() throws InterruptedException, AWTException {
        wrapper.clickByXpath(UR_USER_XPATH);
        wrapper.sendKeysByXpath(FIZFACE_XPATH, "Пупкин");
        wrapper.clickByXpath(ADD_EDIT_DATA_XPATH);
        Thread.sleep(2000);
        ...
        String getTitle = wrapper.getPageTitle();
        log.info(getTitle);
        log.info(String.format("Элемент по xpath = %s найден", getTitle));
        String title = wrapper.getPageTitle();
        return title;
    }

    //******************************************************************************************************************
    public String filingCommentOneSymbol() throws InterruptedException, AWTException {
        wrapper.clickByXpath(UR_USER_XPATH);
        wrapper.sendKeysByXpath(FIZFACE_XPATH, "Пупкин");
        wrapper.clickByXpath(ADD_EDIT_DATA_XPATH);
        Thread.sleep(2000);
