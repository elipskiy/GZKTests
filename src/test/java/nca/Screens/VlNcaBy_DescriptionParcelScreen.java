 ...
 */
public class VlNcaBy_DescriptionParcelScreen {
    DriverWrapper wrapper;

    public static final Logger log = Logger.getLogger(VlNcaBy_DescriptionParcelScreen.class);

    VlNcaBy_DescriptionParcelScreen(WebDriver driver) {
