 ...
 */
public class OzNcaBy_SearchByInvNumScreen {
    DriverWrapper wrapper;

    public static final Logger log = Logger.getLogger(OzNcaBy_SearchByInvNumScreen.class);

    OzNcaBy_SearchByInvNumScreen(WebDriver driver) {
