...
public class VlNcaBy_CityScreen {
    ...
    public VlNcaBy_LocalityZoneNumberScreen goToVlNcaBy_LocalityZoneNumber(){
        wrapper.clickByXpath(NEXT_BTN);
        return new VlNcaBy_LocalityZoneNumberScreen(wrapper.getDriver());
    }
}
