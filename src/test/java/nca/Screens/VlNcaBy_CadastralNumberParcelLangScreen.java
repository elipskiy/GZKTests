 ...
 */
public class VlNcaBy_CadastralNumberParcelLangScreen {
    DriverWrapper wrapper;

    public static final Logger log = Logger.getLogger(VlNcaBy_CadastralNumberParcelLangScreen.class);

    VlNcaBy_CadastralNumberParcelLangScreen(WebDriver driver) {
