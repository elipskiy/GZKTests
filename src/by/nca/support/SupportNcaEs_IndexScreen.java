 ...
 * @since 15.09.2015
 */
public class SupportNcaEs_IndexScreen extends BaseIndexScreen {
    private static final String PAGE_URL = "http://support.nca.by:8888/nka_es.nsf";
    private DriverWrapper wrapper;

    public SupportNcaEs_IndexScreen(WebDriver driver) {
    ...
    public SupportNcaEs_MainScreen goToSupportNcaEs_MainScreen(){
        ...
        return new SupportNcaEs_MainScreen(driver);
    }
}
