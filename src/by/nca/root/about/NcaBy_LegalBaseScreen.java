 ...
 */
public class NcaBy_LegalBaseScreen {
    public NcaBy_LegalBaseScreen(WebDriver driver) {
    ...
    public static final Logger log = Logger.getLogger(NcaBy_LegalBaseScreen.class);
