 ...
 */
public class ObjectivesAndFunctionsScreen {
    public ObjectivesAndFunctionsScreen(WebDriver driver) {
    ...
    public static final Logger log = Logger.getLogger(ObjectivesAndFunctionsScreen.class);
