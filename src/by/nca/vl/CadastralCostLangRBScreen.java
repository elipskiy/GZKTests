 ...
 */
public class CadastralCostLangRBScreen {
    DriverWrapper wrapper;

    public static final Logger log = Logger.getLogger(CadastralCostLangRBScreen.class);

    CadastralCostLangRBScreen(WebDriver driver) {
